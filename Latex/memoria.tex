...
\noindent\includegraphics[width=\textwidth]{cabecera}\vspace{1cm}%
  ...
  {%
    ...
    en Universidad de <UNIVERSIDAD> --- \@date{}\\
    Tutor: \@tutor{}\\
  }%
  \end{center}%
  \null
...
\noindent Que el alumno D. \nombre, con DNI <<dni>>, ha realizado el Trabajo Final de Máster para el Máster Universitario en Inteligencia de Negocio y Big Data en Entornos Seguros titulado <<título de TFM>>. 
